...
def build(configuracion):
    ...
    u.texts("Cantidad de casillas",17, pad = pad_t) + [sg.Combo(["8x8", "10x10", "12x12"],default_value = configuracion["cantidad de casillas"],font = ("Verdana"), pad = pad_i )],
    ...
    u.texts("Tipo de casillas",17, pad = pad_t) + [sg.Combo(["Palabras", "Imagenes", "Ambas"],default_value = configuracion["tipo elementos"],font = ("Verdana"), pad = pad_i )],
    u.texts("Estilos",17, pad = pad_t) + [sg.Combo(["t1", "t2", "t3", "t4", "t5"],default_value = configuracion["estilo"],font = ("Verdana"), size = (15,1), pad = pad_i )],
    u.texts("Ayudas",17, pad = pad_t) + [sg.Combo(["Si", "No"] , default_value= configuracion["ayudas"], font = ("Verdana"), size = (3,1), pad = pad_i )],
    ]
